...
class CryptocurrencyListingsRepository {
  ...
  Future<dynamic> getCryptoCurrencyInfo(List<dynamic> ids) async {
    String formattedIds = ids.join(',');
    var response = await dio.get('/v2/cryptocurrency/info?id=$formattedIds');
